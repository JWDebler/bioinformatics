...
process busco {
    ...
    docker run -v \$(pwd):/busco_wd ezlabgva/busco:${params.buscoversion} busco \
...
process plotBuscoSummaries {
    ...
    docker run -v \$(pwd)/input_derp:/busco_wd ezlabgva/busco:${params.buscoversion} generate_plot.py -wd .
